...
This is a fork of orignal repo, i just added a bat file to build it and used gcc (llms were used to quickly do these tasks) this is my personal prefrence and this forked repo is just me learning Vulkan compute shaders for another GPU related task in cpp im in.

Orignal Repo is Erkaman/vulkan_minimal_compute
